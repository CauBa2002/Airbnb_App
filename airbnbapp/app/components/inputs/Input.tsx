    ...
    return(
        <div className="w-full relative">
            ...
            <input
                ...
                placeholder=" "
                type={type}
                className={`peer w-full p-3 pt-4 font-light bg-white border-2 rounded-md outline-none transition 
            ...
            <label className={`absolute text-md duration-150 transform -translate-y-3 top-5 z-10 origin-[0] 
                            ${formatPrice ? 'left-8' : 'left-3'} peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0
